...
QUnit.test('the environment is sane', function (assert) {
  ...
  assert.strictEqual(typeof Share === 'undefined' ? 'undefined' : _typeof(Share), 'function', 'plugin is a function');
});
...
QUnit.test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(_typeof(Player.prototype.share), 'function', 'videojs-share plugin was registered');
  ...
  assert.ok(this.player.hasClass('vjs-videojs-share'), 'the plugin adds a class to the player');
});
